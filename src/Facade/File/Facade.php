...
namespace Evrinoma\MaterialBundle\Facade\File;

use Evrinoma\MaterialBundle\Manager\File\CommandManagerInterface;
use Evrinoma\MaterialBundle\Manager\File\QueryManagerInterface;
use Evrinoma\MaterialBundle\PreValidator\File\DtoPreValidatorInterface;
