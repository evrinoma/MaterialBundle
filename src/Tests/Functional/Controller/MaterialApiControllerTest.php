 ...
 * @group functional
 */
final class MaterialApiControllerTest extends AbstractFunctionalTest
{
    protected string $actionServiceName = 'evrinoma.material.test.functional.action.material';
    ...
    {
        return [FixtureInterface::MATERIAL_FIXTURES];
    }
}
