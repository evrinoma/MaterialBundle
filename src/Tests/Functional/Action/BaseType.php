...
use Evrinoma\MaterialBundle\Tests\Functional\Helper\BaseTypeTestTrait;
use Evrinoma\MaterialBundle\Tests\Functional\ValueObject\Type\Active;
use Evrinoma\MaterialBundle\Tests\Functional\ValueObject\Type\Brief;
use Evrinoma\MaterialBundle\Tests\Functional\ValueObject\Type\Description;
use Evrinoma\MaterialBundle\Tests\Functional\ValueObject\Type\Id;
...
class BaseType extends AbstractServiceTest implements BaseTypeTestInterface
{
    ...
    public const API_GET = 'evrinoma/api/material/type';
    public const API_CRITERIA = 'evrinoma/api/material/type/criteria';
    public const API_DELETE = 'evrinoma/api/material/type/delete';
    public const API_PUT = 'evrinoma/api/material/type/save';
    public const API_POST = 'evrinoma/api/material/type/create';
